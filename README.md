...
AndroidアプリがDeep Link (`https://rintaro-ko.github.io/callback/`) を捕捉できなかった場合、このページが表示され、Javascriptおよび手動ボタンによってアプリへの復帰（Intent呼び出し）を試みます。

- **URL:** `https://rintaro-ko.github.io/callback/`
